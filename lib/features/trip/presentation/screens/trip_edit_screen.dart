  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      ...
      body: tripAsync.when(
        ...
        data: (trip) {
          if (trip == null) {
            return const AppErrorWidget(message: 'Trip not found');
          }

          // Initialize form with trip data (only once)
          if (!_isInitialized) {
            _titleController.text = trip.title;
            _budgetController.text = trip.budget.toString();
            _selectedCurrency = SupportedCurrency.fromCode(trip.baseCurrency);
